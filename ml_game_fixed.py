...
def loop():
    ...
    try:
        ...
        pass  # Ignore if v4l2-ctl not available
    ...
    print(f"Camera: {fcc} @ {int(cap.get(3))}x{int(cap.get(4))} @ {cap.get(5)} fps")
    ...
    while True:
        ...
        # No artificial FPS limiting - let it run at camera speed
